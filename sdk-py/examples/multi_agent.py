"""Multi-agent (CC/BCC/ReplyAll) demo for the AgentMail Python SDK.

Mirrors examples/multi-agent.ts. Run after starting the AgentMail server.
"""
...
async def main() -> None:
    ...
    async with AgentMail("logger@demo", server=SERVER) as logger:
